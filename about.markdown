...
<ul class="experience-list">
  ...
  <li class="experience-item">
    ...
    <div class="experience-details">
      ...
      <div class="experience-summary">Independent work for universities, charities, and creative agencies.</div>
    </div>
  </li>
  <li class="experience-item">
...
This website runs on [Jekyll](https://www.jekyllrb.com) and is hosted on [GitHub Pages](https://pages.github.com). I built it with a lot of help from [Claude Code](https://claude.com/product/claude-code). There are no trackers or analytics.
